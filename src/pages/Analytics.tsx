    ...
    <div className="flex flex-col gap-4 h-auto lg:h-full w-full pb-4 lg:pb-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
        <motion.div layout className="bento-card rounded-3xl p-6 flex flex-col justify-between h-32 lg:h-40">
          ...
          <div className="flex justify-between items-end">
            <h3 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tighter">42.8k</h3>
        ...
        <motion.div layout className="bento-card rounded-3xl p-6 flex flex-col justify-between h-32 lg:h-40">
          ...
          <div className="flex justify-between items-end">
            <h3 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tighter">8.4k<span className="text-base text-slate-400">/hr</span></h3>
        ...
        <motion.div layout className="bento-card rounded-3xl p-6 flex flex-col justify-between h-32 lg:h-40 bg-slate-800 text-white border-slate-700 shadow-xl">
          ...
          <div className="flex justify-between items-end">
            <h3 className="text-3xl sm:text-4xl font-black text-white tracking-tighter">342</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 h-auto lg:h-full">
        ...
        <motion.div layout className="lg:col-span-4 bento-card rounded-3xl p-8 flex flex-col justify-center items-center relative overflow-hidden bg-white/80 h-auto min-h-[400px] lg:h-full">
           ...
           <div className="w-48 h-48 sm:w-64 sm:h-64 rounded-full border-[12px] border-slate-100 flex flex-col items-center justify-center relative shadow-inner z-10 bg-white shadow-[0_10px_40px_rgba(0,0,0,0.05)] mx-auto shrink-0">
